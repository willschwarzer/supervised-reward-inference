...
GEN_SCRIPT_1="scripts/rl/16cpu_array_generate_reach_087_fixed.sh"
NUM_JOBS_GEN_1=5
# NUM_JOBS_GEN_1=5

gen_job1_id=$(sbatch --array=0-$(($NUM_JOBS_GEN_1-1))%30 $GEN_SCRIPT_1 | awk '{print $4}')
# gen_job1_id=26743107
