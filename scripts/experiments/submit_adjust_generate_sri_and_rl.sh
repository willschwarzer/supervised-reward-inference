...
# NUM_JOBS_GENERATE=120
# GENERATE_SCRIPT="scripts/rl/16cpu_array_generate_reach_adjust.sh"
...
SRI_SCRIPT="scripts/experiments/run_adjust_rfpp_no_inf.sh"
...
RL_SCRIPT="scripts/experiments/run_adjust_rl_rfpp.sh"
