...
NUM_JOBS_ADV=420
ADV_SCRIPT="scripts/experiments/run_noise_adv_new_settings.sh"
...
BC_SCRIPT="scripts/experiments/run_noise_bc_new_settings.sh"
...
EVAL_SCRIPT="scripts/experiments/run_noise_eval_im.sh"
